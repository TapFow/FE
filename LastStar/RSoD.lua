local loadstr,ggb,shp = loadstring,getgenv,sethiddenproperty

fun=tick()

--wxrn("[MINT]: Loading reanimation...")
--wxrn("[MINT]: Thanks 4eyes for the net library!")
--wxrn("[MINT]: Credits to Alsoo3 for the jitterless! he is cool")

loadstr(game:HttpGet("https://raw.githubusercontent.com/TypicallyAUser/random-stuff/main/4eyesnetlib.lua"))()
...
loadstr(game:HttpGet("https://raw.githubusercontent.com/TypicallyAUser/TypicalsConvertingLibrary/main/renameallhatclones"))()
local Library = loadstr(game:HttpGet("https://raw.githubusercontent.com/TypicallyAUser/TypicalsConvertingLibrary/main/Main"))()
Stopped=false
local R15toR6
...
if Character:FindFirstChild("Torso") then
	R15toR6 = false
	--prxnt("Turned off r15 to r6. ur r6")
else
	R15toR6=true
...
if Modes.Animations then
	loadstr(game:HttpGet("https://raw.githubusercontent.com/TypicallyAUser/TypicalsConvertingLibrary/main/Animations"))().R6(Dummy.Animate)
